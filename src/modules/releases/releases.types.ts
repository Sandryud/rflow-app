...
export type ApproveReleaseParams = GetReleaseParams;

export type ApproveReleaseResponse = Prisma.ReleaseGetPayload<{
  select: typeof updateReleaseSelect;
}>;

export type RejectReleaseParams = GetReleaseParams;
...
export type MarkReleaseAsReleasedParams = GetReleaseParams;

export type MarkReleaseAsReleasedResponse = Prisma.ReleaseGetPayload<{
  select: typeof updateReleaseSelect;
}>;
